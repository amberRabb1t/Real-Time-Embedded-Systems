        ...
        case LWS_CALLBACK_CLIENT_RECEIVE: {
            ...
            if (type != NULL) {
                ...
                if (data != NULL) {
                    ...
                    json_t *px_obj = json_object_get(metrics, "px"); // this is the price of the trade; if many trades were aggregated, this is the price of each one (it's the same for all of them, hence why they were grouped)
